...
python csv_to_scatter.py $result_file true false "bigstep" "no bigstep" --compare-by "Time (MC)" --filter "Epsilon:0.0001,Region Bound:0" --output-pdf $folder/"time_1e-4_0.pdf"
python csv_to_scatter.py $result_file true false "bigstep" "no bigstep" --compare-by "Time (MC)" --filter "Epsilon:1e-05,Region Bound:0" --output-pdf $folder/"time_1e-5_0.pdf"
...
python csv_to_scatter.py $result_file true false "bigstep" "no bigstep" --compare-by "Time (MC)" --filter "Epsilon:0.0001,Region Bound:0.1" --output-pdf $folder/"time_1e-4.pdf"
python csv_to_scatter.py $result_file true false "bigstep" "no bigstep" --compare-by "Time (MC)" --filter "Epsilon:1e-05,Region Bound:0.1" --output-pdf $folder/"time_1e-5.pdf"
