...
module PM
    ...
    [tick0] state=0 & q*10 <= T1*QMAX -> P11 : (pm'=0) + P12 : (pm'=1) + (1-P11-P12) : (pm'=2);

    [tick0] state=0 & q*10 > T1*QMAX & q*10 <= T2*QMAX -> P21 : (pm'=0) + (P22) : (pm'=1) + (1-P21-P22) : (pm'=2);

    [tick0] state=0 & q*10 > T2*QMAX & q*10 <= T3*QMAX -> P31 : (pm'=0) + (P32) : (state'=1) + (1-P31-P32) : (state'=2);

    [tick0] state=0 & q*10 > T3*QMAX -> P41 : (pm'=0) + (P42) : (state'=1) + (1-P41-P42) : (state'=2);
endmodule
