...
module process5 = process1 [ x1=x5, x0=x4, i1=i5, c1=c5, c0=c4, x1new=x5new ] endmodule
module process6 = process1 [ x1=x6, x0=x5, i1=i6, c1=c6, c0=c5, x1new=x6new ] endmodule
module process7 = process1 [ x1=x7, x0=x6, i1=i7, c1=c7, c0=c6, x1new=x7new ] endmodule
module process8 = process1 [ x1=x8, x0=x7, i1=i8, c1=c8, c0=c7, x1new=x8new ] endmodule
module process9 = process1 [ x1=x9, x0=x8, i1=i9, c1=c9, c0=c8, x1new=x9new ] endmodule
module process10 = process1 [ x1=x10, x0=x9, i1=i10, c1=c10, c0=c9, x1new=x10new ] endmodule
module process11 = process1 [ x1=x0, x0=x10, i1=i11, c1=c0, c0=p0, x1new=x0new ] endmodule
...
label "stable" = num_tokens=1 & initialized & !c0 & !c1 & !c2 & !c3 & !c4 & !c5 & !c6 & !c7 & !c8 & !c9 & !c10;
